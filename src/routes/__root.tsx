...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ResQNet - Hyperlocal Disaster Intelligence" },
      { name: "description", content: "Offline-first disaster intelligence dashboard for India." },
      { property: "og:title", content: "ResQNet - Hyperlocal Disaster Intelligence" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Geist:wght@300;400;500;600;700&family=Geist+Mono:wght@400;500&family=Space+Grotesk:wght@500;600;700&family=DM+Sans:wght@500;600;700&display=swap",
      },
    ],
  }),
