...
async function aiAnswer(question: string, b: Awaited<ReturnType<typeof fetchBundle>>): Promise<string> {
  ...
  const context = {
    ...
    nearby_fire_hotspots: b.weather.nearby_fire_hotspots ?? 0,
    recent_earthquakes: b.weather.recent_quake_count ?? 0,
    max_quake_mag: b.weather.max_quake_magnitude ?? 0,
    verified_citizen_reports: b.weather.nearby_verified_reports ?? 0,
    blocked_roads: b.weather.blocked_roads_nearby ?? 0,
